...
class tpch7{
    ...
    public static String cleanStatement(String sql) throws JSQLParserException {
        ...
        ExpressionDeParser expr = new tpch7.ReplaceLongValues();
    ...
    public static void main(String args[]) throws Exception {
        ...
        mutationAttrValues.add("customer.c_acctbal -> 9900 9700 9600 9500; >");
        ...
        do {
            query = mutatedQueries.get(0); //rand.nextInt(mutatedQueries.size())
...
//        }
        ...
        for(int i = 0; i < s.size(); i++) {
            ...
            if(!(whyNot.get(1).contains("000000100") || whyNot.get(1).contains("000000197")
                    || whyNot.get(1).contains("000000219") || whyNot.get(1).contains("000000468")
                    || whyNot.get(1).contains("000000518") || whyNot.get(1).contains("000000780")
                    || whyNot.get(1).contains("000000987") || whyNot.get(1).contains("000001042")
                    || whyNot.get(1).contains("000001370") || whyNot.get(1).contains("000001573"))) {
                s.remove(i);
                i--;
            }
        }
